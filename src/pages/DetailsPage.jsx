...
import { CiWarning, CiFlag1 } from "react-icons/ci";
  ...
  return (
    <div className="flex flex-col bg-black">
      <div className="flex bg-blue-gray-900 px-2 py-4 items-center">
        ...
        <div className="ml-5 w-1/5 my-3 flex items-center">
          <CiWarning className=" w-8 h-8 mr-3 text-yellow-700" />
        ...
        <div className="flex items-center">
          ...
          <CiFlag1 className=" w-5 h-5 text-gray-400" />
        </div>
      </div>
      <div className="bg-blue-gray-900 my-3 py-3 h-full flex items-center">
        ...
        <div className="border-l-2 border-dashed border-gray-400 h-3 mx-4"></div>
      </div>
              ...
              <div className="flex">
                <div className="px-3 flex items-center">
                  <div
                    ...
                    className="h-1 w-5 ml-3 rounded-sm"
                  ></div>
                  <span className="text-white text-xs ml-2">AI Forecast</span>
                </div>
              </div>
              <div className="flex">
                <div className="px-3 flex items-center">
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center text-white cursor-pointer">
          <span className="mx-3 font-semibold text-teal-300">Filter</span>
          <IoFilterSharp className="text-teal-300 transition-transform transform hover:scale-125" />
        </div>
    ...
    <table className="table-auto text-white font-semibold w-full border-0 overflow-auto">
      <tbody>
        {tableData.data.map((row, rowIndex) => (
          ...
          >
            <td className="px-2">Data {rowIndex + 1}</td>
